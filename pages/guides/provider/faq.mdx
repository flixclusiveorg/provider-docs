import providerSettingsButtonPreview from '../../../public/provider-faq/provider-settings-button.png';
import troubleshoot1Preview from '../../../public/provider-faq/troubleshoot-1.png';
import troubleshoot2Preview from '../../../public/provider-faq/troubleshoot-2.png';
import troubleshoot3Preview from '../../../public/provider-faq/troubleshoot-3.png';
...
<Frame>
    <img src={providerSettingsButtonPreview.src} alt="Provider's settings button" />
</Frame>
...
<Steps>
    <Steps.Step>
        ...
        <Frame>
            <img src={troubleshoot1Preview.src} alt='Test provider button preview' />
        </Frame>
    </Steps.Step>
    <Steps.Step>
        ...
        <Frame>
            <img src={troubleshoot2Preview.src} alt='Test case item preview' />
        </Frame>
    </Steps.Step>
    <Steps.Step>
        ### Report the logs
        ...
        <Frame>
            <img src={troubleshoot3Preview.src} alt='Issue a bug button preview' />
        </Frame>
